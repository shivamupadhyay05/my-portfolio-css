    ...
    <div className="footer-card">
      <div className="footer-left">
        ...
        <div className="footer-socials">
          <a href="https://www.linkedin.com/in/shivam-upadhyay-34666b277/" target="_blank" rel="noopener noreferrer" className="footer-social linkedin" aria-label="LinkedIn">
        ...
        <div className="footer-contact-details">
          ...
          <span><strong>LinkedIn:</strong> <a href="https://www.linkedin.com/in/shivam-upadhyay-34666b277/" target="_blank" rel="noopener noreferrer">linkedin.com/in/</a></span><br/>
